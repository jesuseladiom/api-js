...
var _person = require("../services/person.service");
...
var getPersons = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _person.methods.readPersons(res);

          case 3:
            query = _context.sent;
            if (query.length) res.json(query);else res.json({
              "message": "No data"
            });
            _context.next = 11;
            break;
  ...
  return function getPersons(_x, _x2) {
...
var getPerson = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _person.methods.readPerson(req.params, res);
  ...
  return function getPerson(_x3, _x4) {
...
var addPerson = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var flagError, _req$body, first_name, last_name, edad, genero, query;
...
var deletePerson = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _context4.next = 3;
            return _person.methods.deletePerson(req.params, res);

          case 3:
            query = _context4.sent;
            if (query.affectedRows) res.json({
  ...
  return function deletePerson(_x7, _x8) {
